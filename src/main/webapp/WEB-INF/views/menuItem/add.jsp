...
<div class="container">
  <div class="form-card">
    <h1 class="form-title">Add Menu <span>Item</span></h1>
    <p class="form-sub">Fill in the details below to add a new item to the menu.</p>
    ...
    <form method="post" action="${pageContext.request.contextPath}/menuItems">
      ...
      <div class="field-group">
        ...
        <div class="field full">
          ...
          <input id="name" name="name" type="text" placeholder="e.g. Grilled Chicken Burger" required/>
        </div>
        ...
        <div class="field full">
          ...
          <textarea id="description" name="description" placeholder="Describe the item, ingredients, preparation…"></textarea>
        </div>
