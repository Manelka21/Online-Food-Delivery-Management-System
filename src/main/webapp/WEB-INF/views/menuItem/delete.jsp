...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card-title { font-family: 'Playfair Display', serif; font-size: 1.75rem; font-weight: 700; margin-bottom: .5rem; }
    ...
    .item-box-name { font-weight: 500; font-size: 1.05rem; margin-bottom: .4rem; }
    .item-box-row {
      display: flex;
      justify-content: space-between;
      font-size: .82rem;
