...
<body class="bg-gray-50 min-h-screen flex flex-col items-center justify-center p-6">
  ...
  <div class="w-full max-w-md bg-white rounded-3xl shadow-sm border border-gray-200 p-10">
    <div class="text-center mb-8">
      <div class="text-6xl mb-">🚴</div>
      <h1 class="text-2xl font-extrabold text-gray-1800 tracking-tight">Delivery Driver Portal</h1>
      <p class="text-sm text-gray-800 mt-1">Sign in to your delivery account</p>
    </div>
    ...
    <form action="${pageContext.request.contextPath}/driver/login" method="post" class="space-y-4">
      <div>
        <label class="block text-base font-bold text-gray-800 mb-2" for="email">Email Address</label>
      ...
      <div>
        <label class="block text-base font-bold text-gray-800 mb-2" for="password">Password</label>
        <input type="password" id="password" name="password" class="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-sm" placeholder="••••••••" required/>
      </div>
      <button type="submit" class="w-full bg-green-500 hover:bg-blue-800 text-white font-bold py-3.5 rounded-4xl transition shadow-sm text-base">Sign In →</button>
    </form>
